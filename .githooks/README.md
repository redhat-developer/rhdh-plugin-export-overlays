...
Runs **ESLint**, **Prettier**, and **TypeScript** checks on staged `workspaces/*/e2e-tests/**` files. Mirrors the [E2E Code Quality](../.github/workflows/e2e-code-quality.yaml) CI workflow.
