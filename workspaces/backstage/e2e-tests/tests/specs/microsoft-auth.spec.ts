...
/**
 * Documented mid-suite config update:
 * applyConfigMapFromObject → rolloutRestart
 * https://redhat-developer.github.io/rhdh-e2e-test-utils/guide/deployment/rhdh-deployment.html
 */
...
test.describe(
  ...
  () => {
    ...
    async function setMicrosoftResolver(
      ...
      await applyAppConfigAndRestart(rhdhDeployment, appConfig);
    }
