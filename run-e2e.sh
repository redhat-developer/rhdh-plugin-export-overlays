...
# TODO: revert once redhat-developer/rhdh-e2e-test-utils#168 is merged and published
E2E_TEST_UTILS_GIT_REF="${E2E_TEST_UTILS_GIT_REF:-rm3l/rhdh-e2e-test-utils#fix/allow-http-egress-for-keycloak}"
